...
No_of_block = len(Blockchain_data)
print('No. Of Blocks In Blockchain : ', No_of_block)

# Write Task 02 code from below
print('Previous Hash Code Of Gnesis Block : ', blockchain.chain[0]['previous_hash'])
print('Current Hash Code Of Gnesis Block : ', blockchain.chain[0]['Current_hash'])
...
if blockchain.chain[0] ['Current_hash'] == blockchain.chain[1] ['previous_hash']:
    ...
    print('Oh No! The Hash Of The Current Block Does Not Match With The Previous Block')
